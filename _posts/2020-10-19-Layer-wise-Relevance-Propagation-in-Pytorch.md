...
![figure]({{ site.baseurl }}/images/catLRP.jpg)*Relevance is then backpropagated from the top layer down to the input, where $\{R_p\}$ denotes the pixel-wise relevance scores, that can be visualized as a heatmap. Source: [Montavon et al](https://doi.org/10.1016/j.patcog.2016.11.008)*
