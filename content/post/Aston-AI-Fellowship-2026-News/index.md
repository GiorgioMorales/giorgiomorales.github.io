...
<div style="display: flex; justify-content: center;">
    <img src="acaira.jpg" alt="figure" width="60%">
</div>

<figure style="display: flex; flex-direction: column; align-items: center;">
    <img src="flags.png" alt="figure" width="90%">
    <figcaption style="text-align: center; margin-top: 5px; font-style: italic;">
        I moved from Normandy, France to Birmingham, UK. Left: Normandy flag. Right: Royal Banner of England. Image generated with Gemini.
    </figcaption>
</figure>